...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  p {
	...
	<title>Formulir Pengajuan Sidang Komisi S2/S3</title>
</head>
...
<body>
	<table  cellpadding="0" style="width: 590px;">
		<tbody>
            <tr>
                ...
                <td style="width: 370px">Pengajuan Sidang Komisi S2/S3</td>
                <td style="width: 160px">Sidang komisi ke : </td>
                <td></td>
            </tr>
            <tr>
                <td>Lampiran</td>
                <td>:</td>
                <td>Bukti lunas SPP dari Bag. Keuangan (Loket 2)</td>
            </tr>
            <tr>
                <td>Kepada Yth</td>
                <td>:</td>
    ...
    <p style="text-align: justify;">
        Dengan hormat,<br>
		Dengan ini diberitahukan bahwa Komisi Pembimbing Mahasiswa Program Pascasarjana (S2/S3) :
	</p>
	<table cellpadding="0" style="width: 590px;">
		<tbody>
			<tr>
	...
	<p style="text-align: justify;">
		Akan mengajukan pertemuan Komisi pada :
    </p>
    ...
    <table cellpadding="0" style="width: 590px;">
        <tbody>
            <tr>
                ...
                <td style="width: 10px">:</td>
                <td style="width: 310px">{{ Auth::user()->hari_sidang }}, {{ $tanggal_sidang }}</td>
            </tr>
            <tr>
                <td>Jam</td>
                <td>:</td>
                <td>{{ $waktu_mulai_sidang }} - {{ $waktu_selesai_sidang }}</td>
            </tr>
            <tr>
                <td>Bertempat di</td>
                <td>:</td>
	...
	<table border="0" style="width: 590px;">
        <tbody>
            ...
            <tr>
                ...
                <tr>
                    <td><u>{{ '$pengesah->nama_pengesah' }} </u></td>
                    <td><u>{{ Auth::user()->nama_mhs }}</u></td>
                </tr>
                <tr>
                    <td>NIP. {{ '$pengesah->nip_pengesah' }}</td>
    ...
    <p style="text-align: justify;">
        <i>
            Catatan: <br>
            Proses Administrasi &plusmn; 7 (tujuh) hari kerja
        </i>
    </p>
</body>
</html>
